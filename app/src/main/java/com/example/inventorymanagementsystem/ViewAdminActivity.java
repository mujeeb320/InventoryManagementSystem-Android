...
public class ViewAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = findViewById(R.id.view_admin_user_ID);
        firstName = findViewById(R.id.view_admin_first_name);
        lastName = findViewById(R.id.view_admin_last_name);
        address = findViewById(R.id.view_admin_address);
        phoneNumber = findViewById(R.id.view_admin_phone_number);
        nic = findViewById(R.id.view_admin_nic);
        update = findViewById(R.id.update_admin_btn);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(firstName.getText().toString()) ||
                    ...
                    new DialogBox(ViewAdminActivity.this, "All Fields Are Mandatory!");
                } else {
    ...
    private void loadAdmin() {
        try {
                Call<User> call = api.ViewUser(user_ID);
                ...
                call.enqueue(new Callback<User>() {
                    ...
                    public void onFailure(Call<User> call, Throwable t) {
                        new DialogBox(ViewAdminActivity.this, "Error 1 !");
                    }
                });
            }catch(Exception e){
            new DialogBox(ViewAdminActivity.this, "Error 2 !");
        }
    }
    ...
    private void updateAdmin() {
        try{
            ...
            Call<String> call = api.updateAdmin(viewUser);

            call.enqueue(new Callback<String>() {
                @Override
                public void onResponse(Call<String> call, Response<String> response) {
                    new DialogBox(ViewAdminActivity.this, "Admin Details Updated!");

                }

                @Override
                public void onFailure(Call<String> call, Throwable t) {
                    new DialogBox(ViewAdminActivity.this, "Error 3");
                }
            });
        }catch(Exception e ){
            new DialogBox(ViewAdminActivity.this, "Error 4!");
        }
    }
